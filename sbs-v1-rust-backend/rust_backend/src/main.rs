...
use routes::endpoints::{
   GET_BACKTEST_FEATURE_MAP, GET_HISTORICAL_GAMES, GET_HISTORICAL_ODDS, GET_PLAYERS_BY_TEAM_AND_SEASON, GET_PLAYER_STATS_BY_ID_AND_SEASON, NBA_API_ROOT, SERVER_URL
};
use db::constants::{
   SBS_V1_DB_NAME, 
   ...
   let _ = HttpServer::new(move || {
        ...
        .service(
            web::scope(NBA_API_ROOT)
                ...
                .route(GET_BACKTEST_FEATURE_MAP, web::get().to(get_feature_map_for_backtest))
