use log::info;
use rust_backend::{handlers::{self, handlers::{execute_aggregation_query, get_nba_team_stats, get_ui_login_credentials}}, initializers::initialize_app_state, proxy, routes::{self, endpoints::{CREDENTIALS_API_ROOT, DB_QUERY_API_ROOT, EXECUTE_MONGO_QUERY, GET_LOGIN_CREDENTIALS, GET_NBA_TEAM_STATS}}};
