use log::info;
use rust_backend::{handlers::{self, handlers::{execute_aggregation_query, get_github_auth, get_google_auth, get_nba_daily_matchups, get_nba_team_stats, get_ui_login_credentials}}, initializers::initialize_app_state, proxy, routes::{self, endpoints::{CREDENTIALS_API_ROOT, DB_QUERY_API_ROOT, EXECUTE_MONGO_QUERY, GET_GITHUB_AUTH, GET_GOOGLE_AUTH, GET_LOGIN_CREDENTIALS, GET_NBA_DAILY_MATCHUPS, GET_NBA_TEAM_STATS}}};
