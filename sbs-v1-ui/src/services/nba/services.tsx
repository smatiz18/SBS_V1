...
import { GetNbaGamesReqByTeamAndSeason } from "./get-nba-games-req-by-team-and-season";
import { NbaGameHistorical } from "../../models/nba-game-historical";
import { GetNbaOddsReqByTeamAndSeason } from "./get-nba-odds-req-by-team-and-season";
...
export function get_nba_games_by_team_and_season(req: GetNbaGamesReqByTeamAndSeason): Promise<AxiosResponse<NbaGameHistorical[]>> {
...
export function get_nba_odds_by_team_and_season(req: GetNbaOddsReqByTeamAndSeason): Promise<AxiosResponse<NbaOddsHistorical[]>> {
